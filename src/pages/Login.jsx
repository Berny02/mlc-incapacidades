      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-accent">
            <span className="text-xl font-bold text-bg">M</span>
          </div>
          <h1 className="text-xl font-semibold text-text">MLC Soluciones</h1>
          <p className="mt-1 text-sm text-muted">Gestión de Incapacidades</p>
        </div>
